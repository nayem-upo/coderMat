  ...
  return (
    <div className="py-10 md:py-20 text-white relative">
      ...
      {loading ? (
        ...
        <div className="max-w-5xl 2xl:max-w-[105rem] mx-auto grid md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 3xl:grid-cols-5 gap-y-10 mt-10 md:mt-20 justify-items-center z-0">
          {techStack.map((stack) => (
